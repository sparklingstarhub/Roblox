if game:GetService("CoreGui"):FindFirstChild("Sayuri HUB [ Blox Fruit ]") then
   game:GetService("CoreGui"):FindFirstChild("Sayuri HUB [ Blox Fruit ]"):Destroy()
end
...
local venyx = library.new("Sayuri HUB [ Blox Fruit ]", 5013109572)
...
local section1 = page:addSection("Credit: Sayuri")
section1:addButton("Copy Discord Server", function()
setclipboard("https://discord.gg/KSyPPWHsQH")
end)
